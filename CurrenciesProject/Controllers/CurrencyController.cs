        ...
        public async Task<IActionResult> Get([FromQuery]int page)
        {
            ...
            try
            {
                ...
                if (Id == 7)
                {
                    ...
                    result.previouspage = "https://localhost:44318/api/currencies?page=6";
                }
                else if (Id == 1)
                {
                    ...
                    result.nextpage = "https://localhost:44318/api/currencies?page=2";
                ...
                else
                {
                    ...
                    result.nextpage = "https://localhost:44318/api/currencies?page=" + Convert.ToString(Id + 1);
                    result.previouspage = "https://localhost:44318/api/currencies?page=" + Convert.ToString(Id - 1);
                }
                return Ok(result);
            }
            catch (Exception)
